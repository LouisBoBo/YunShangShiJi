...
//    self.styleChangeButton.frame = Frame(8, 11, 23.3, 23.3);
    
    self.styleChangeButton.autoresizingMask = UIViewAutoresizingFlexibleTopMargin;
    [self.styleChangeButton setImage:[UIImage imageNamed:@"FM_Chat_voice"] forState:UIControlStateNormal];//NormalTalk@2x.png
    [self.styleChangeButton setImage:[UIImage imageNamed:@"FM_Chat_keyBoard"] forState:UIControlStateSelected];//keyBoard@2x.png
...
//    [self.styleChangeButton setImage:[UIImage imageNamed:@"chatBar_keyboard"] forState:UIControlStateSelected];
    ...
    self.styleChangeButton.imageView.contentMode = UIViewContentModeScaleAspectFit;//wzz
...
//    [self.moreButton setImage:[UIImage imageNamed:@"chatBar_more"] forState:UIControlStateNormal];//FDC_Chat_more
    [self.moreButton setImage:[UIImage imageNamed:@"FDC_Chat_more"] forState:UIControlStateNormal];
...
//     [self.moreButton setImage:[UIImage imageNamed:@"FM_Chat_keyBoard"] forState:UIControlStateSelected];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"FM_Chat_face"] forState:UIControlStateNormal];
...
//    [self.faceButton setImage:[UIImage imageNamed:@"chatBar_keyboard"] forState:UIControlStateSelected];
    [self.faceButton setImage:[UIImage imageNamed:@"FM_Chat_keyBoard"] forState:UIControlStateSelected];
...
//    self.recordButton.frame = CGRectMake(textViewLeftMargin, kVerticalPadding, self.faceButton.frame.origin.x+self.frame.size.width-textViewLeftMargin, kInputTextViewMinHeight);//wzz
//    self.faceButton.hidden = YES;//wzz
...
//        self.recordView = [[DXRecordView alloc] initWithFrame:CGRectMake(90, 130, 140, 140)];
        self.recordView = [[DXRecordView alloc] initWithFrame:CGRectMake((kApplicationWidth-187)/2, 130, 187, 187)];
    }
...
- (void)buttonAction:(id)sender
{
    ...
    if (button == self.styleChangeButton) {
        

        if (button.selected) {
            CGRect rect = self.recordButton.frame;
            rect.size.width = self.frame.size.width-(cgrectm(self.styleChangeButton)*2)-12;
            ...
            float mins = FrameXW(self.styleChangeButton)*2+6*2;
            
            rect.size.width = self.inputTextView.frame.size.width;
            self.recordButton.frame = rect;
    ...
    switch (tag) {//self.styleChangeButton
        case 0://切换状态
        {
            if (button.selected) {
                self.faceButton.selected = NO;
        ...
        case 1://表情self.faceButton
        {
            ...
            break;
        case 2://更多self.moreButton
        {
            self.faceButton.hidden = NO;//wzz
