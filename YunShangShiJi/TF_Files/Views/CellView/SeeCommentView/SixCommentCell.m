...
//    //type = %d",model.cellType);
    ...
    NSMutableAttributedString *maStr2 = [[NSMutableAttributedString alloc] initWithString:addCommentStr];
    [maStr2 addAttributes:@{NSForegroundColorAttributeName:COLOR_ROSERED} range:NSMakeRange(0, 6)];
    self.addCommentLabel.attributedText = maStr2;
    self.addCommentLabel.numberOfLines = 5;
    
    NSString *commentStr2 = [NSString stringWithFormat:@"[卖家回复]%@",model.suppEndCommentModel.supp_content];
    NSMutableAttributedString *maStr3 = [[NSMutableAttributedString alloc] initWithString:commentStr2];
    [maStr3 addAttributes:@{NSForegroundColorAttributeName:COLOR_ROSERED} range:NSMakeRange(0, 6)];
    self.suppEndCommentLabel.attributedText = maStr3;
