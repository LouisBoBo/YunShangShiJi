...
- (void)receiveDataModel:(TFCommentModel *)model
{
    ...
    self.CommentTextLabel.textColor = kTitleColor;
...
//    MyLog(@"imgUrl = %@",imgUrl);
    ...
    self.sizeLabel.textColor = kTextColor;
    
    self.colorLabel.text = [NSString stringWithFormat:@"颜色:%@",model.shop_color];
    self.colorLabel.textColor = kTextColor;
...
//    //time = %@",model.add_date);
    ...
    self.addTimeLabel.textColor = kTextColor;
    ...
    self.commentTypeLabel.textColor = kTextColor;
