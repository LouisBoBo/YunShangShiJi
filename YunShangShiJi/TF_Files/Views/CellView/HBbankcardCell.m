...
//  YunShangShiJi
//
//  Created by ios-1 on 16/1/28.
//  Copyright © 2016年 ios-1. All rights reserved.
//

#import "HBbankcardCell.h"
#import "GlobalTool.h"
@implementation HBbankcardCell
...
- (void)awakeFromNib {
    ...
    self.time.frame = CGRectMake(self.backimage.frame.size.width-ZOOM(90*3.4), self.time.frame.origin.y, ZOOM(100*3.4), self.time.frame.size.height);
