...
@interface TFSearchViewController ()<PopoverViewDelegate,StickyHeaderFlowLayoutDelegate>
{
...
- (void)getData
{
    ...
    BottomHeight = self.isbrowse?ZOOM6(60):0;
...
//    flowLayout.minimumInteritemSpacing = 0;
    ...
    self.collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, kNavigationheightForIOS7+BottomHeight, kScreenWidth, kScreenHeight-kNavigationheightForIOS7-BottomHeight) collectionViewLayout:[self layout]];
...
{
    //导航条
    self.navigationView =[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, kApplicationWidth, Height_NavBar)];
...
//    [self.navigationView addSubview:vil];
    ...
    backbtn.centerY = View_CenterY(self.navigationView);
    [backbtn addTarget:self action:@selector(leftBarButtonClick) forControlEvents:UIControlEventTouchUpInside];
    [self.navigationView addSubview:backbtn];
    
    
    self.headScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(45, IS_IPHONE_X?44:20+(44-HeadHeight)/2, kScreenWidth-45, HeadHeight)];
...
//    self.headScrollView.backgroundColor = [UIColor greenColor];
    ...
    self.headLabel.centerY = View_CenterY(self.navigationView);
    ...
    setbtn.centerY = View_CenterY(self.navigationView);
