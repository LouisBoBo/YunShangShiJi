...
#import "GlobalTool.h"
@implementation CollectionMenuReusableView
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self=[super initWithFrame:frame]) {
//        _headerMenuView = [[UIImageView alloc]init];
//        _headerMenuView.frame = CGRectMake(0,0, kScreenWidth,frame.size.height);
//        [_headerMenuView addSubview:self.menubackview];
...
- (NewMenuButtonView *)menubackview
{
    if (!_menubackview) {
        _menubackview = [[NewMenuButtonView alloc] init];
        _menubackview.frame = CGRectMake(0, 0, kScreenWidth, ZOOM6(70));
...
@implementation NewMenuButtonView
