...
@property (nonatomic, weak)   id<TYSlidePageScrollViewDataSource> tyDataSource;
@property (nonatomic, weak)   id<TYSlidePageScrollViewDelegate> tyDelegate;
...
@property (nonatomic, strong) CustomTitleView *pageTabBar; //defult nil
