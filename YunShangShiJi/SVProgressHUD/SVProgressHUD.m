...
+ (SVProgressHUD *)sharedManager
{
    static SVProgressHUD *ManagerInstance = nil;
...
#pragma clang diagnostic pop
    ...
    self.hudView.bounds = CGRectMake(0.0f, 0.0f, 50.0f,50.0f);
...
- (UIColor *)foregroundColorForStyle{
    if(self.defaultStyle == SVProgressHUDStyleLight){
        return [UIColor colorWithRed:255/255.0 green:63/255.0 blue:139/255.0 alpha:255/255.0];
