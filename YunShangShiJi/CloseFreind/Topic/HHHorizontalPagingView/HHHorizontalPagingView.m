...
+ (HHHorizontalPagingView *)pagingViewWithHeaderView:(UIView *)headerView
    ...
    HHHorizontalPagingView *pagingView = [[HHHorizontalPagingView alloc] initWithFrame:CGRectMake(0., Height_NavBar, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height-Height_NavBar)];
    
//    pagingView.horizontalCollectionView = [[UICollectionView alloc] initWithFrame:pagingView.frame collectionViewLayout:layout];
    pagingView.horizontalCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, pagingView.frame.size.width, pagingView.frame.size.height-50) collectionViewLayout:layout];
