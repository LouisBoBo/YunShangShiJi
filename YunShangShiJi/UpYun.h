...
#define DEFAULT_BUCKET @"yssj668"
#define CHESHI_BUCKET @"yssj-real-test"

/**
 *	@brief	默认表单API功能密钥 （必填项），可在init之后修改passcode的值来更改
 */
#define DEFAULT_PASSCODE @"M3s2N+dRDbjzzRATbBP5IbYIThc="

#define CHESHI_PASSCODE @"T8CDRaESN017je6QcRjYqmjxXkw="
/**
