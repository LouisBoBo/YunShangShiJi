...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //监听通知
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(pushoff:) name:@"pushoff" object:nil];
...
-(void)pushoff:(NSNotificationCenter*)note
{
    [self dismiss];
}
