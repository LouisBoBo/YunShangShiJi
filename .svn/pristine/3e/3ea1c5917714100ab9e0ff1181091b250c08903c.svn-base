...
View.fiveFrame=function(){
	...
	if(!$.cookie("fiveFrame")&&!$.cookie("fiveFrameTime")){
		...
		var fiveHtml='<div id="fiveFrame" class="absolute" style="width:280px;height:400px;top:50%;margin-top:-200px;left:50%;margin-left:-140px;z-index:9999991;"><a class="f-right closeFrame"><img class="f-right" src="https://yssj668.b0.upaiyun.com/H5/public/img/store/frame/close.png" width="30"></a><img src="https://yssj668.b0.upaiyun.com/H5/public/img/store/frame/five.png" width="100%"><div class="t-center"><img src="https://yssj668.b0.upaiyun.com/H5/public/img/store/frame/btn.png" width="140"></div><div>';
		...
		$("#fiveFrame .t-center img").on("click",function(){
			...
			if(App.islogin()){
				...
				if(App.getUrlParam("s")){
					window.location.href=basePath+"view/download/6.html?realm="+realm+"&shop_code="+App.getUrlParam("s");
				}else{
					window.location.href=basePath+"view/download/6.html?realm="+realm;
				}
