...
- (void)updateUI {
    self.trackColor = [UIColor groupTableViewBackgroundColor];
...
- (CAGradientLayer *)gradientLayer {
    if (!_gradientLayer) {
        ...
        _gradientLayer.colors = @[(id)tarbarrossred.CGColor,
                                 (id)tarbarrossred.CGColor];
...
//        _progressLabel.textColor = [UIColor colorWithRed:0.310 green:0.627 blue:0.984 alpha:1.000];
        _progressLabel.textColor = tarbarrossred;
        _progressLabel.textAlignment = NSTextAlignmentCenter;
        _progressLabel.font = [UIFont systemFontOfSize:ZOOM6(36)];
