...
@implementation FiveCommentCell
...
//    //type = %d",model.cellType);
    ...
    NSString *commentStr = [NSString stringWithFormat:@"[卖家回复]%@",model.suppEndCommentModel.supp_content];
    ...
    self.suppEndCommentLabel.attributedText = maStr;
    self.suppEndCommentLabel.numberOfLines = 5;
