...
@interface FiveCommentCell : UITableViewCell
...
@property (weak, nonatomic) IBOutlet UILabel *suppEndCommentLabel;

@property (weak, nonatomic) IBOutlet UIView *addCommentView;
@property (weak, nonatomic) IBOutlet UILabel *addCommentLabel;
@property (weak, nonatomic) IBOutlet UIImageView *addCommentImageView1;
@property (weak, nonatomic) IBOutlet UIImageView *addCommentImageView2;
@property (weak, nonatomic) IBOutlet UIImageView *addCommentImageView3;
...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *photoView2_height;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *photoView2_BottomHeight;
