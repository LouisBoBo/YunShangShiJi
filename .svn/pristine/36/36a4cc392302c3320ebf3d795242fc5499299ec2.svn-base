 ...
 */
-(instancetype)initWithFrame:(CGRect)frame withViews:(NSArray *)views withButtonNames:(NSArray *)names withThreeAnimation:(int)choose withTag:(int)tag withImage:(NSArray*)images;//实例方法
+(instancetype)scrollWithFrame:(CGRect)frame withViews:(NSArray *)views withButtonNames:(NSArray *)names withThreeAnimation:(int)choose withTag:(int)tag withImage:(NSArray*)images;//类方法
...
/**
 *     2、点击被选中的按钮时时候展示 缩放按钮 的动画效果,默认为 NO
 */
...
@property (nonatomic ,copy) NSArray *xl_buttonImages;
