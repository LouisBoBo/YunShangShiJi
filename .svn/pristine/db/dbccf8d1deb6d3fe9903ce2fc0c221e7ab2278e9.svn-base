...
/** 13.开始时间 */
@property (nonatomic, copy) NSString * _Nullable lockIn_startdate;
@property (nonatomic, copy) NSString * _Nullable lockIn_nowdate;
@property (nonatomic, strong)NSMutableArray * _Nonnull lockIn_list;
