//
//  FightIndianaDetailViewController.h
//  YunShangShiJi
//
...
@interface FightIndianaDetailViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate,UIAlertViewDelegate,UIAlertViewDelegate, TYSlidePageScrollViewDelegate>
...
//拼团夺宝详情
@property (nonatomic, strong)NSMutableArray *fightIndianaData;
//虚拟参与人数
...
@property (nonatomic, strong) UIButton *activeRuleBtn;    //活动规则
@property (nonatomic, strong) UIButton *AnnouncedBtn;     //往期揭晓
@property (nonatomic, strong) UIButton *RecordBtn;        //夺宝记录
@property (nonatomic, strong) NSString *tuserId;          //团长的ID
@property (nonatomic, assign) BOOL indiaType;             //是否参团
@property (nonatomic, strong) NSString *issue_code;       //往期的期号
@end
