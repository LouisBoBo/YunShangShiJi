...
@interface WantSendredViewController ()<UIWebViewDelegate,TFJSObjCModelDelegate,NJKWebViewProgressDelegate>
...
@implementation WantSendredViewController
...
- (void)viewDidLoad {
    ...
    [super setNavigationItemLeft:@"发红包"];
...
- (void)httpWebViewReload
{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@view/hb/isend.html",HTTPURLH5];
    NSLog(@"urlStr = %@",urlStr);
