...
@interface RejoinCartSaleCell : UITableViewCell
...
@property (strong, nonatomic)  UILabel *shopOne;
@property (strong, nonatomic)  UILabel *shopTwo;
@property (strong, nonatomic)  UILabel *shopThree;
...
@property (strong, nonatomic)  UILabel *zeroShoppingLabel;

@property (strong, nonatomic)  UITextField *numTextField;

@property (nonatomic, copy) dispatch_block_t deleteBlock;//重新加入
@property (nonatomic, copy) dispatch_block_t editeBlock;//删除
