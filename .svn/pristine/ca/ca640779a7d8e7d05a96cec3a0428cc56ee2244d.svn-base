...
#import "FaceBoard.h"
@interface TopicDetailViewController : UIViewController<UITextViewDelegate,FaceBoardDelegate>
...
@property (nonatomic , strong) dispatch_block_t browseCountBlock;
