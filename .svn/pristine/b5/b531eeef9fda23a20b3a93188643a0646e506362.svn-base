...
{
    spkey  = [NSString stringWithString:[NSString stringWithFormat:@"%@",key]];
}
//获取debug信息
...
//提交预支付
-(NSString *)sendPrepay:(NSMutableDictionary *)prePayParams :(NSMutableDictionary*)dic
{
...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPay_demo:(NSMutableDictionary*)dic :(NSString*)orderno
{
    ...
    NSString *noncestr  = [NSString stringWithFormat:@"%@", dic[@"nonce_str"]];
    NSString *order_code   = [NSString stringWithFormat:@"%@",orderno];
...
//    NSString *orderno   = [NSString stringWithFormat:@"%ld",time(0)];
    ...
    [packageParams setObject: order_code           forKey:@"out_trade_no"];//商户订单号
//    [packageParams setObject: @"196.168.1.1"    forKey:@"spbill_create_ip"];//发器支付的机器ip
    [packageParams setObject:[NSString stringWithFormat:@"%@",[NSObject baseURLStr]]    forKey:@"spbill_create_ip"];//发器支付的机器ip
